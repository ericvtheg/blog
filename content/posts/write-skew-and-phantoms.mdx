...
Before diving into transaction isolation, lets discuss what we are trying to avoid.
...
that can occur in our database and how we can mitigate them using transaction isolation.
